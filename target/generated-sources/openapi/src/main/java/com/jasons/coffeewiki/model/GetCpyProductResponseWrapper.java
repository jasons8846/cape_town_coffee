...
public class GetCpyProductResponseWrapper {
  ...
  private @Nullable GetCpyProductResponse data;

  private JsonNullable<Object> error = JsonNullable.<Object>undefined();

  public GetCpyProductResponseWrapper data(@Nullable GetCpyProductResponse data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty("data")
  public @Nullable GetCpyProductResponse getData() {
    return data;
  }

  @JsonProperty("data")
  public void setData(@Nullable GetCpyProductResponse data) {
    this.data = data;
  }
