...
public class GetCompanyNameResponseWrapper {
  ...
  private @Nullable Company data;

  private JsonNullable<Object> error = JsonNullable.<Object>undefined();

  public GetCompanyNameResponseWrapper data(@Nullable Company data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty("data")
  public @Nullable Company getData() {
    return data;
  }

  @JsonProperty("data")
  public void setData(@Nullable Company data) {
    this.data = data;
  }
